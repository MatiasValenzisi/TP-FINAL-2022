                ...
                <div class="guardiandisplay">
                    ...
                    <div class="col-md-5 col-sm- col-xs-12 profile_details ">
                        <div class="profile_view">
                            <div class="col-sm-12">
                                <h4 class="brief"><i><?php echo "Token: ". $guardian->getToken(); ?></i>
                                </h4>
                                <div class="left col-xs-7">
                                    ...
                                    <ul class="list-unstyled">
                                        <li><i class="fa fa-envelope"></i> Correo:
                                            <?php echo $guardian->getUserName().""; ?></li>
                                        <li><i class="fa fa-calendar"></i> Fecha de nacimiento:
                                            <?php echo date("d-m-Y", strtotime($guardian->getBirthDate())); ?>
                                        </li>
                                        <li><i class="fa fa-history"></i> Experiencia:
                                            <?php echo $guardian->getExperience() . " Año/s."; ?></li>
                                    </ul>
                                </div>
