...
<body>
    ...
    <form action="<?php echo FRONT_ROOT?>/sign/createUser" method="POST">
        <input type="hidden" name="date" value="<?php $this->date=new DateTime();?>">


        <div class="container-fluid" style="width:70%; height:50%;">
            <div>
                <h2 class="title">¿Que te parecio el servicio?</h2>

            </div>

            <div class="row sideways">
                <div class="col-md-12 col-xs-12">
                    <label class="form-label" for="score">Calificacion:</label>

                    <select class="form-control" id="score" name="score" onchange="">
            ...
            <div class="row sideways">
                ...
                <div class="col-md-12 col-xs-12">
                    <label class="form-label" for="observations">Guardian:</label>
            ...
            <div class="buttons ">
                ...
                <button type="submit" class="btn btn-success col-md-6 col-sm-6 col-xs-12">Enviar</button>
            </div>
        </div>
