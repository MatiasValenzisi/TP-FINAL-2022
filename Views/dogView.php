                ...
                <div class="x_content"><br>
                    ...
                    <form class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <img src="<?php echo VACCINATION.$this->dog->getVaccinationPlan() ?>"
                                alt="" height="320" width="320">
                            </div>
                        </div>  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea class="form-control" style="resize:none;" readonly><?php echo $this->dog->getObservations() ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <img src="<?php echo PHOTO.$this->dog->getPhoto() ?>"
                                alt="" height="320" width="320">
                            </div>
                        </div> 
                        ...
                        <div class="form-group">                            
                            <button type="button" style="margin-left: 30%;" onclick="location.href='<?php echo FRONT_ROOT ?>/pet/list'" class="btn btn-primary">Volver al listado de mascotas</button>
                        </div>
