                  ...
                  echo "$".$guardian->getServicePrice();
                            ...
                            <td>
                                <a class="text-success"
                                    href="<?php echo FRONT_ROOT ?>/guardian/confirmGuardian/<?php echo $guardian->getToken(); ?>"><b>Aceptar</b></a>
                                /
                                <a class="text-danger"
                                    href="<?php echo FRONT_ROOT ?>/guardian/declineGuardian/<?php echo $guardian->getToken(); ?>"><b>Rechazar</b></a>
                            </td>
