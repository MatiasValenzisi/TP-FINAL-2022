                        ...
                        <div class="x_panel">
                            ...
                            <div class="form-horizontal form-label-left">                                 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                          <label class="form-control col-md-7 col-xs-12" style="font-weight: normal;">
                                            <?php echo $this->guardian->getPetSize(); ?>
                                          </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                        ...
                                        <button type="button" onclick="location.href='<?php echo FRONT_ROOT ?>/booking/consult/<?php echo $this->guardian->getToken(); ?>'" class="btn btn-success" style="width:40%;">Consultar reserva</button>
                                    </div>
                                </div>
